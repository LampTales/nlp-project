...
class BertSentimentClassifier(torch.nn.Module):
    ...
    def __init__(self, config):
        ...
        self.downstream_tower = torch.nn.Sequential(
    ...
    def forward(self, input_ids, attention_mask):
        ...
        ### TODO
        # raise NotImplementedError
        cls_emb = self.bert(input_ids, attention_mask)['pooler_output']
        logits = self.downstream_tower(cls_emb)
        return logits
...
if __name__ == "__main__":
    ...
    config = SimpleNamespace(
        filepath='trained/cfimdb-classifier.pt',
        lr=args.lr,
        use_gpu=args.use_gpu,
        epochs=args.epochs,
        batch_size=8,
